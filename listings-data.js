 ...
 *  status:      "For Sale" | "For Rent" | "New" | "Pending" | "Sold"
 *
 *  categories: use "for-sale" or "for-rent" to match the filter tabs
 * ============================================================
 */

const LISTINGS = [
  // ── FOR SALE (IDs 1, 2, 3, 5, 9) ─────────────────────────
  {
    id: 1,
    ...
    features: [
      "Chef's kitchen with quartz countertops", "Open-plan living and dining",
      "Primary suite with spa bath", "2-car attached garage",
      "Landscaped rear garden", "Hardwood floors throughout",
      "Smart home system", "Covered outdoor entertaining area",
      "Custom closets and millwork", "River Oaks school district",
      "Minutes from River Oaks Country Club", "New roof (2022)"
    ],
    nearby: [
  ...
  },
  {
    ...
    features: [
      "Modern craftsman architecture", "Open kitchen with waterfall island",
      "French doors to covered porch", "Primary suite with double vanities",
      "2-car detached garage", "No HOA",
      "Walking distance to Heights restaurants", "Hardwood floors throughout",
      "Energy-efficient construction (2020)", "Private backyard",
      "Laundry room with utility sink", "Pre-wired for security system"
    ],
    nearby: [
  ...
  },
  {
    ...
    features: [
      "Gated motor court entry", "Resort-style pool and spa",
      "La Cornue range & marble counters", "Butler's pantry",
      "Primary suite with dual spa baths", "3-car garage with epoxy floors",
      "Formal dining & paneled study", "Covered loggia & outdoor kitchen",
      "Generator (whole home)", "Custom dressing room",
      "Spring Branch ISD schools", "0.35 acre landscaped lot"
    ],
    nearby: [
  ...
  },
  {
    ...
    features: [
      "Zoned to top-rated Bellaire ISD", "No HOA",
      "Gourmet kitchen with white cabinetry", "Family room with fireplace",
      "Upstairs game/flex room", "Primary suite with walk-in closet",
      "2-car attached garage", "Covered back patio",
      "Hardwood floors main level", "Walking distance to parks",
      "Minutes from Rice Village", "Cul-de-sac street"
    ],
    nearby: [
  ...
  },
  {
    ...
    features: [
      "2022 luxury construction", "Private rooftop terrace",
      "Houston skyline views", "Italian cabinetry in kitchen",
      "Bosch appliance package", "10-foot ceilings",
      "Engineered hardwood floors", "2-car garage",
      "Steps from METRORail", "Midtown Park walkable",
      "Calacatta quartz countertops", "Frameless glass shower"
    ],
    nearby: [
  ...
  // ── FOR RENT (IDs 4, 6, 7, 8) ─────────────────────────────
  {
    ...
    description: [
      "Set on one of Montrose's most energetic corridors, 1822 Westheimer Road is a sleek, contemporary townhome available for rent. Three bedrooms, 2.5 baths, and an exceptional inner-loop location in Houston's most culturally vibrant neighborhood.",
    ...
    features: [
      "Contemporary 2019 construction", "Wide-plank oak flooring",
      "Bosch kitchen appliances", "Private rooftop terrace",
      "Third-floor primary retreat", "2-car garage",
      "Low-maintenance landscaping", "Energy Star certified",
      "Steps from Montrose restaurants", "Museum District nearby",
      "Walkable neighborhood", "Smart thermostat & locks"
    ],
    nearby: [
  ...
  },
  {
    ...
    description: [
      "3301 Rice Boulevard is a landmark West University Place residence — a distinguished five-bedroom estate available for rent. This gracious home offers resort-style living in one of Houston's most coveted zip codes.",
      "The grand entry opens to a paneled library, formal dining room, and a spectacular kitchen-family room at the rear. The chef's kitchen features a professional range, marble countertops, custom cabinetry, and a butler's pantry.",
      "The resort-style rear grounds feature a covered outdoor kitchen, pool, and spa set against mature landscaping. Three upper-level bedrooms and a primary suite with sitting room round out the exceptional floor plan.",
      "Zoned to West University Elementary, minutes from Rice University, Rice Village, and the Museum District. A rare rental opportunity in a neighborhood that almost never rents."
    ],
    features: [
      "Resort pool, spa & outdoor kitchen", "Paneled library",
      "Formal dining room", "Primary suite with sitting room",
      "3-car garage", "Mature landscaping",
      "Smart home system", "West University Elementary district",
      "Walking distance to Rice University", "Multiple living areas",
      "Wine cellar", "Available immediately"
    ],
    nearby: [
  ...
  },
  {
    ...
    description: [
      "Situated in the master-planned Cinco Ranch community, 420 Cinco Ranch Blvd is an immaculate four-bedroom home available for rent, zoned to Katy ISD — consistently ranked among Texas's best school districts.",
      ...
      "Cinco Ranch residents enjoy resort-style amenities including multiple pools, walking trails, tennis courts, and scenic lakes — all within minutes."
    ],
    features: [
      "Katy ISD schools", "Open kitchen with granite island",
      "Primary suite with soaking tub", "Covered back patio",
      "2-car garage", "Community pools & trails",
      "Flex/study room", "Sprinkler system",
      "Energy-efficient 2018 build", "Cul-de-sac location",
      "Walking distance to Cinco Ranch Lake", "Minutes to I-10 & Energy Corridor"
    ],
    nearby: [
  ...
  },
  {
    ...
    description: [
      "Just listed for rent — 1609 First Colony Blvd is a stunning 2021-built home in Sugar Land's prestigious First Colony community. Four bedrooms, a 3-car garage, and an exceptional open floor plan make this a standout rental opportunity.",
      ...
      "Fort Bend ISD schools, community walking trails, and easy access to Sugar Land Town Center and major Houston highways make this an ideal rental choice."
    ],
    features: [
      "2021 new construction", "GE Café appliance suite",
      "Two-story entry foyer", "Main-level primary suite",
      "Game room upstairs", "3-car garage",
      "Fort Bend ISD (top-rated)", "Bay windows in primary suite",
      "Custom closet system", "Community walking trails",
      "Quartz countertops throughout", "Tankless water heater"
    ],
    nearby: [
